...
function __CatspeakLiveGumshoe(_directory, _extension, _return_struct = false, _force_lcnames = true, _generator = undefined, _force_forward_slash = undefined)
{
    ...
    if (_return_struct)
    {
        ...
        return __CatspeakGumshoeStruct(_directory, _extension, _match_all_mask, _path_sep, _generator);
    }
    else
    {
        return __CatspeakGumshoeArray(_directory, _extension, [], _match_all_mask, _path_sep);
    }
}
...
/// @param matchAllMask
/// @param pathSeparator
function __CatspeakGumshoeArray(_directory, _extension, _result, _match_all_mask, _path_sep)
{
    var _directories = [];
    ...
    {
        __CatspeakGumshoeArray(_directories[_i], _extension, _result, _match_all_mask, _path_sep);
        ++_i;
    }
...
function __CatspeakGumshoeStruct(_directory, _extension, _match_all_mask, _path_sep, _generator)
{
    var _directories = [];
    var _result = {};
    ...
    repeat(array_length(_directories))
    {
        variable_struct_set(_result, _directories[_i], __CatspeakGumshoeStruct(_directory + _directories[_i] + _path_sep, _extension, _match_all_mask, _path_sep, _generator));
        ++_i;
    }
